...
- (instancetype)initWithFileURL:(NSURL *)fileURL name:(NSString *)name
{
    ...
    if (self) {
        ...
        if (pathExtension == nil || pathExtension.length == 0) {
            ...
            [self setMIMEWithExtension:pathExtension];
        }
    }
    return self;
}
...
- (instancetype)initWithFileData:(NSData *)fileData name:(NSString *)name fileName:(NSString *)fileName mimeType:(NSString *)mimeType
{
    ...
    if (self) {
        ...
        self.name = name;
        self.fileName = fileName==nil?name:fileName;
        self.mimeType = mimeType==nil?@"application/octet-stream":mimeType;
    }
    return self;
}
static NSDictionary *__extensionMIMEMap;
- (void)setMIMEWithExtension:(NSString *)extension {
    if (__extensionMIMEMap == nil) {
        __extensionMIMEMap =
    ...
    NSString *mime = [__extensionMIMEMap objectForKey:extension];
    if (mime == nil) {
